...
public class MinimaxMove extends Player implements AI{

    private Point skippingPoint;
    private int depth;
    private long totalTimeElapsed;
    private double numMovesCalled;
    public MinimaxMove(String name, Side s)
    {
        super(name, s);
    }
    public MinimaxMove(Side s, int depth)
    {
        super("MinimaxAI", s);
        this.depth = depth;
...
//        return b.getNumBlackPieces() - b.getNumWhitePieces();
        ...
        double result = 0;
        if(getSide() == Side.WHITE)
            result = b.getNumbOfWhiteKingPieces() * kingWeight + b.getNumbOfWhiteNormalPieces() - b.getNumbOfBlackKingPieces() *
                    kingWeight -
                    b.getNumbOfBlackNormalPieces();
        else
            result = b.getNumbOfBlackKingPieces() * kingWeight + b.getNumbOfBlackNormalPieces() - b.getNumbOfWhiteKingPieces() *
                    kingWeight -
                    b.getNumbOfWhiteNormalPieces();
        return result;
